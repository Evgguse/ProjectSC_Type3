...
{
    public partial class FormDiagramm2 : MetroFramework.Forms.MetroForm
    {
        BDprojectsc db = new BDprojectsc();
        public FormDiagramm2()
        {
            InitializeComponent();
        }
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            chart1.ChartAreas[0].AxisY.Title = "Кол-во курсов";

            dgView.DataSource = fir;
            dgView.Columns[0].HeaderText = "Преподаватель";
            dgView.Columns[1].HeaderText = "Кол-во курсов";
        }
        ...
        {
            {
                ...
                .Select(n => new
                {
                    ...
                    Price = n.Zakaz.Count(m => m.id_prepod == n.id_prepod)
                }).ToList();
